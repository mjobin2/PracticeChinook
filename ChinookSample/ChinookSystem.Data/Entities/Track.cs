...
namespace ChinookSystem.Data.Entities
{
    ...
    public class Track
    {
        ...
        //[StringLength(int maximum[,int minimum], ErrorMessage="message")]
        //[Range(double minimum, double maximum, ErrorMessage="message")]
        //[RegularExpression("expression", Errormessage="message")]
        [Key]
